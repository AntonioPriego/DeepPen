...
QT_MOC_LITERAL(5, 17), // "operationFinished"
QT_MOC_LITERAL(23, 0), // ""
QT_MOC_LITERAL(24, 7), // "operate"
QT_MOC_LITERAL(32, 11), // "MainWindow*"
QT_MOC_LITERAL(44, 6) // "window"

    },
    "Task\0operationFinished\0\0operate\0"
    "MainWindow*\0window"
};
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->operationFinished(); break;
        case 1: _t->operate((*reinterpret_cast< std::add_pointer_t<MainWindow*>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Task::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::operationFinished)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Task, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
