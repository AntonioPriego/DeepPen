...
\begin{figure}[h]
    \centering
    \subfloat[Perceptron]{\includegraphics[width=0.25\textwidth]{capturas/esquemaPerceptron.png}}
    \hfill
    \subfloat[Multilayer Perceptron]{\includegraphics[width=0.75\textwidth]{capturas/esquemaMLPerceptron.png}}
