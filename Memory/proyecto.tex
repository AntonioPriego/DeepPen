...
\color{mitexto}
	...
	\input{capitulos/03_Analisis_de_requisitos.tex}

	% Skectch cargado en la placa
	\input{capitulos/04_Microcontrolador.tex}

	% Diseño y entrenamiento de la red neuronal
	\input{capitulos/05_Red_neuronal.tex}

	% Diseño interfaz de usuario 
	\input{capitulos/06_Interfaz_de_usuario.tex}

	% Entrenamiento
	%\input{capitulos/entrenamiento.tex}

	% Notas
	%\input{capitulos/apendice.tex}

	% Notas
	%\input{capitulos/intento_Harvard.tex}

	% Herramientas
	\input{capitulos/07_Herramientas.tex}
	...
	% Apéndice
	\input{capitulos/08_Apendice}

	% Validación
	\input{capitulos/09_Validacion.tex}

	% Trabajos futuros
	\input{capitulos/10_Trabajos_futuros.tex}
